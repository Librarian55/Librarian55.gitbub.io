    ...
    window.opspark.runLevelInGame = function(game) {
        ...
        var levelData = {
            ...
            gameItems: [
                ...
                {type: 'badGuy',x:600,y:groundY},
                {type: 'badGuy',x:900,y:groundY},
                {type: 'badguy',x:1200,y:groundY},
        ...
        for (var i= 0; i<= levelData.gameItems.length-1; i++) { 
            ...
            if ("badGuy" === gameItem.type){
                createBadGuy(gameItem.x, gameItem.y)
            }
            if ("sawBlade" === gameItem.type){
                createSawBlade(gameItem.x,gameItem.y)
            }
            if ("reward" === gameItem.type){
